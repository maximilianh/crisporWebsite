...
For some genomes, there is no gene annotation. This is the case when we could not find a valid gene model (GFF) file for the genome. You are welcome to contact us by email, if you have a gene model file or want us to add one.
