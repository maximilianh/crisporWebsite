For new installations, two virtual environment needs to be installed to run Base editing scoring models
...
- After some testing, the outputs appear to be identical for both versions of python
