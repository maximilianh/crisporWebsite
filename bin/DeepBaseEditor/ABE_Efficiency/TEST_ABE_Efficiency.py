...
_DEFAULT_WEIGHT_DIR = os.path.join(_SCRIPT_DIR, "ABE_Efficiency_Weight")
...
def predict(handle, sequences, batch_size=500):
    """Run inference on a list of 25-bp sequences. Returns a 1D numpy array of efficiency scores (percent)."""
